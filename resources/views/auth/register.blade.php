            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="avatar" class="col-md-4 col-form-label text-md-right">{{ __('Selecciona un avatar') }}</label>

                            <div class="col-md-6">
                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input" id="avatar" @error('avatar') is-invalid @enderror" name="avatar" autocomplete="avatar">
                                                    <label class="custom-file-label" for="avatar">Selecciona la imagen</label>
                                                </div>
                            </div>
                        </div>
